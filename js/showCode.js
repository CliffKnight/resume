...
var showCode = function(name, cfg) {
    ...
    var $rightSide =$('<ul class="side_right"><li><p class="title">个人简历</p><p>jquery+fullpage插件实现</p><p>组件化的开发方式</p><p>jquery+fullpage插件实现页面切换效果</p><p>利用自定义事件，对于项目中事件触发顺序进行管理</p><p><a href="#">查看效果</a><a href="#">代码地址</a></p></li><li><p class="title">2048游戏</p><p>一个仿2048游戏的例子</p><p>随机方块生成，分数统计</p><p>即时的交互响应</p><p><a href="#">查看效果</a><a href="#">代码地址</a></p></li></ul>');
